...
namespace UnityEngine
{
    ...
    public class SeasonalRuleTile<T> : SeasonalRuleTile
    {
        /// <summary>
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "New Seasonal Rule Tile", menuName = "Tiles/Seasonal Rule Tile")]
    [HelpURL("https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@latest/index.html?subfolder=/manual/RuleTile.html")]
    public class SeasonalRuleTile : TileBase
    {
        public static int SeasonalIndex { get; set; }
        ...
        public class TilingRuleOutput
        {
            ...
            public enum OutputSprite
            {
                ...
                Animation,
                /// <summary>
                /// A Sprite based on SeasonIndex will be output.
                /// </summary>
                Season
        ...
        /// </summary>
        [HideInInspector] public List<TilingRule> m_TilingRules = new List<SeasonalRuleTile.TilingRule>();
                ...
                if (RuleMatches(rule, position, tilemap, ref transform))
                {
                    switch (rule.m_Output)
                    {
                        ...
                        case TilingRuleOutput.OutputSprite.Random:
                            ...
                            break;
                        case TilingRuleOutput.OutputSprite.Season:
                            tileData.sprite = rule.m_Sprites[SeasonalIndex];
                            break;
                    }
