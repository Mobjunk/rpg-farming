...
{
    /// <summary>
    /// The Editor for a SeasonalRuleTile.
    /// </summary>
    [CustomEditor(typeof(SeasonalRuleTile), true)]
    [CanEditMultipleObjects]
    public class SeasonalRuleTileEditor : Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change SeasonalRuleTile");
        ...
        /// <summary>
        /// The SeasonalRuleTile being edited
        /// </summary>
        public SeasonalRuleTile tile => target as SeasonalRuleTile;
        ...
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null, typeof(SeasonalRuleTile.TilingRule), true, true, true, true);
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, SeasonalRuleTile.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        {
            SeasonalRuleTile.TilingRule rule = tile.m_TilingRules[index];
        ...
        public float GetElementHeight(SeasonalRuleTile.TilingRule rule)
        {
            BoundsInt bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            float inspectorHeight = GetElementHeight(rule as SeasonalRuleTile.TilingRuleOutput);
        ...
        public float GetElementHeight(SeasonalRuleTile.TilingRuleOutput rule)
        {
            float inspectorHeight = k_DefaultElementHeight + k_PaddingBetweenRules;

            switch (rule.m_Output)
            {
                case SeasonalRuleTile.TilingRule.OutputSprite.Random:
                case SeasonalRuleTile.TilingRule.OutputSprite.Animation:
                    inspectorHeight = k_DefaultElementHeight + k_SingleLineHeight * (rule.m_Sprites.Length + 3) + k_PaddingBetweenRules;
                    break;
                case SeasonalRuleTile.TilingRule.OutputSprite.Season:
        ...
        /// <summary>
        /// Gets the GUI matrix size for a Rule of a SeasonalRuleTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a SeasonalRuleTile.</returns>
        ...
        private void OnAddElement(object obj)
        {
            ...
            SeasonalRuleTile.TilingRule rule = new SeasonalRuleTile.TilingRule();
            rule.m_Output = SeasonalRuleTile.TilingRule.OutputSprite.Single;
        ...
        /// <summary>
        /// Saves any changes to the SeasonalRuleTile
        /// </summary>
        ...
        /// </summary>
        /// <param name="target">SeasonalRuleTile which has been updated</param>
        //public static void UpdateAffectedOverrideTiles(SeasonalRuleTile target)
        //{
        ...
        /// <summary>
        /// Gets all RuleOverrideTiles which override the given SeasonalRuleTile
        /// </summary>
        /// <param name="target">SeasonalRuleTile which has been updated</param>
        /// <returns>A list of RuleOverrideTiles which override the given SeasonalRuleTile</returns>
        public static List<RuleOverrideTile> FindAffectedOverrideTiles(SeasonalRuleTile target)
        {
        ...
        private void ResizeRuleTileList(int count)
        {
            if (tile.m_TilingRules == null)
                tile.m_TilingRules = new List<SeasonalRuleTile.TilingRule>();
            while (tile.m_TilingRules.Count > count)
                tile.m_TilingRules.RemoveAt(tile.m_TilingRules.Count - 1);
            while (tile.m_TilingRules.Count < count)
                tile.m_TilingRules.Add(new SeasonalRuleTile.TilingRule());
        }

        /// <summary>
        /// Draw editor fields for custom properties for the SeasonalRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Gets the index for a Rule with the SeasonalRuleTile to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the SeasonalRuleTile to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case SeasonalRuleTile.TilingRule.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case SeasonalRuleTile.TilingRule.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, SeasonalRuleTile.TilingRule.Transform ruleTransform)
        {
            switch (ruleTransform)
            {
                case SeasonalRuleTile.TilingRule.Transform.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case SeasonalRuleTile.TilingRule.Transform.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case SeasonalRuleTile.TilingRule.Transform.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case SeasonalRuleTile.TilingRule.Transform.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case SeasonalRuleTile.TilingRule.Transform.MirrorXY:
        ...
        public void RuleNeighborUpdate(Rect rect, SeasonalRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, SeasonalRuleTile.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (SeasonalRuleTile.TilingRule.Transform)(int)Mathf.Repeat((int)tilingRule.m_RuleTransform + GetMouseChange(), Enum.GetValues(typeof(SeasonalRuleTile.TilingRule.Transform)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        /// Draws a Rule Matrix for the given Rule for a SeasonalRuleTile.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(SeasonalRuleTile tile, Rect rect, BoundsInt bounds, SeasonalRuleTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        /// Draws a Rule Matrix Icon for the given matching Rule for a SeasonalRuleTile with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(SeasonalRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position, Rect rect)
        {
        ...
        public virtual void SpriteOnGUI(Rect rect, SeasonalRuleTile.TilingRuleOutput tilingRule)
        {
        ...
        public void RuleInspectorOnGUI(Rect rect, SeasonalRuleTile.TilingRuleOutput tilingRule)
        {
            float y = rect.yMin;
            ...
            tilingRule.m_Output = (SeasonalRuleTile.TilingRule.OutputSprite)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_Output);
            y += k_SingleLineHeight;

            if (tilingRule.m_Output == SeasonalRuleTile.TilingRule.OutputSprite.Animation)
            {
            ...
            if (tilingRule.m_Output == SeasonalRuleTile.TilingRule.OutputSprite.Random)
            {
                ...
                tilingRule.m_RandomTransform = (SeasonalRuleTile.TilingRule.Transform)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_RandomTransform);
                y += k_SingleLineHeight;
            }

            if (tilingRule.m_Output != SeasonalRuleTile.TilingRule.OutputSprite.Single)
            {
                GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight)
                    , tilingRule.m_Output == SeasonalRuleTile.TilingRuleOutput.OutputSprite.Animation ? Styles.tilingRulesAnimationSize : Styles.tilingRulesRandomSize);
                EditorGUI.BeginChangeCheck();
        ...
        /// <summary>
        /// Whether the SeasonalRuleTile has a preview GUI
        /// </summary>
        ...
        /// <summary>
        /// Draws the preview GUI for the SeasonalRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Creates a Preview for the SeasonalRuleTile.
        /// </summary>
        ...
        /// <summary>
        /// Renders a static preview Texture2D for a SeasonalRuleTile asset
        /// </summary>
        /// <param name="assetPath">Asset path of the SeasonalRuleTile</param>
        ...
        /// <returns>Texture2D containing static preview for the SeasonalRuleTile asset</returns>
        ...
        class RuleTileRuleWrapper
        {
            ...
            /// </summary>
            [SerializeField]
            public List<SeasonalRuleTile.TilingRule> rules = new List<SeasonalRuleTile.TilingRule>();
        }

        /// <summary>
        /// Copies all Rules from a SeasonalRuleTile to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the SeasonalRuleTile to copy from</param>
        [MenuItem("CONTEXT/SeasonalRuleTile/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            SeasonalRuleTile tile = item.context as SeasonalRuleTile;
            if (tile == null)
                return;
        ...
        /// <summary>
        /// Pastes all Rules from the clipboard to a SeasonalRuleTile
        /// </summary>
        /// <param name="item">MenuCommand storing the SeasonalRuleTile to paste to</param>
        [MenuItem("CONTEXT/SeasonalRuleTile/Paste Rules")]
